<?php
    ...
    $sql = "SELECT * FROM post WHERE id_resp IS NULL";
        ...
        <section id="posts">
                    ...
                    ?>
                        <div class="post">
                            ...
                            <a href="./post.php?id=<?php echo $row['id']; ?>">🌸Ir al post🌸</a><!--PARA HACER LA NUEVA PAGINA-->
                        </div>
                    <?php
                        }
                    ?>
                ...
                <section id="new-post">
                    ...
                    <form action="./logica/addPost.php" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="id_resp" VALUE="0">
