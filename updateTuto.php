<?php
    require './logica/conexion.php';
        ...
        if(!isset($_GET['id'])){
            ...
            header("Location: http://localhost/proyecto/tutorial.php?error=No se encontro el elemento a editar");
...
<body>
    ...
    <div class="contenido-container">
        ...
        <section id="new-post">
                <h2>EditarTutorial</h2>

                <form action="./logica/updateTuto.php" method="POST" enctype="multipart/form-data">
